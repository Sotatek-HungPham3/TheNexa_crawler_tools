...
try:
    ...
    sql = "SELECT symbol, ref_id FROM masterdata WHERE exchange ='upbit'"
    ...
    sql = "SELECT id, in_token, out_token, fee_token FROM upbit_summary_transactions"
    mycursor.execute(sql)
    ...
    for row in rows:
        ...
        sql = """
            UPDATE upbit_summary_transactions
